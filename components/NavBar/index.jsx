...
export default function NavBar(props) {
  ...
  return (
    <Disclosure as="nav" className="bg-dark border-b border-indigo-300">
      {({ open }) => (
        <>
                ...
                <form className="w-full max-w-lg lg:max-w-xs" onSubmit={onSearch}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      data-testid="search"
                      name="search"
                      className="block w-full rounded-md border border-transparent bg-zinc-700 py-2 pl-10 pr-3 leading-5 text-gray-300 placeholder-zinc-400 focus:border-indigo focus:bg-zinc focus:text-gray-900 focus:outline-none focus:ring-white sm:text-sm"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
            ...
            <div className="border-t border-gray-700 pt-4 pb-3">
              {!user ?
                <Disclosure.Button
                  as="button"
                  onClick={onSignIn}
                  className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-indigo-400 hover:text-white"
                >
                  Sign In
                </Disclosure.Button>
                :
