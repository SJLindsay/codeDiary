...
export default function Post({ totalLikes, onComment, onLike, totalComments, onShare, liked, post, user, className = "" }) {
      ...
      <div className={twMerge("flex items-center m-auto", className)}>
        ...
        <div className="ml-4 flex-1">
          <div className="flex items-center justify-between">
            ...
            <p className="pl-5 text-sm text-indigo-900">{formatTimeAgo(post.createdAt)}</p>
          </div>
